...
Component.options.__file = "E:\\www.vue.com\\src\\js\\src\\views\\itemx.vue"
...
exports.default = {
    props: ['title'],
    methods: {
        click_remove: function click_remove() {
            this.$emit('remove');
        }
    }
};
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-7a040901", module.exports)
  }
}

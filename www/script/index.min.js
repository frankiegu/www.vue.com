...
new _vue2.default({
    ...
    methods: {
        addNewTodo: function addNewTodo(ev) {
            console.log(ev);
            this.todos.push({
                id: this.nextTodoId++,
...
var update = __webpack_require__(83)("0ed47b04", content, false);

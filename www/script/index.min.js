...
var store = new _vuex2.default.Store({
    state: {
        count: 0,
        items: [{ id: 0, text: '蔬菜' }, { id: 1, text: '奶酪' }, { id: 2, text: '牛肉' }]
    },
    mutations: {
...
_axios2.default.get("http://192.168.204.61/upkey?name=35892.mp4&size=8290785").then(function (response) {
    console.log("->", response.data);
}).catch(function (error) {
    console.log(error);
});
console.log((0, _jquery2.default)("#app"));
var datasource = {
    name: "测试",
    tabs: [{ text: "巴士" }, { text: "快车" }, { text: "专车" }, { text: "顺风车" }, { text: "出租车" }, { text: "代驾" }]
};
var vuea = new _vue2.default({
    el: "#example",
    data: function data() {
        return datasource;
    },
...
var watchExampleVM = new _vue2.default({
    el: '#watch-example',
    data: function data() {
        return {
            question: '',
    ...
    methods: {
        getAnswer: _lodash2.default.debounce(function () {
            var _this = this;
            ...
            this.answer = '解答中...';
            _axios2.default.get('https://yesno.wtf/api').then(function (response) {
                _this.answer = _lodash2.default.capitalize(response.data.answer);
            }).catch(function (error) {
                _this.answer = '问题API异常. ' + error;
            });
        }, 500)
    }
});
_vue2.default.component('todo-itemx', {
...
new _vue2.default({
    ...
    methods: {
        addNewTodo: function addNewTodo(type, event) {
            if (event) {
        ...
        removefun: function removefun(index) {

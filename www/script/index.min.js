...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash__ = __webpack_require__(161);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    components: {
        'index': function index() {
            return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 228));
        }
    }
});
__WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("/sign?name=35892.mp4&size=8290785").then(function (response) {
    console.log("->", response.data);
}).catch(function (error) {
    console.log(error);
});
console.log(__WEBPACK_IMPORTED_MODULE_2_jquery___default()("#app"));
var datasource = {
    name: "测试",
    tabs: [{ text: "巴士" }, { text: "快车" }, { text: "专车" }, { text: "顺风车" }, { text: "出租车" }, { text: "代驾" }]
};
var vuea = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: "#example",
    data: function data() {
        return datasource;
    },
...
var vuexv = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#vuex',
...
var watchExampleVM = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods: {
        getAnswer: __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.debounce(function () {
            var _this = this;
            ...
            this.answer = '解答中...';
            __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get('https://yesno.wtf/api').then(function (response) {
                _this.answer = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.capitalize(response.data.answer);
            }).catch(function (error) {
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('todo-itemx', function () {
    return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 229));
});
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
...
var _data = { counter: 0 };
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('simple-counter', {

...
var Parser = __webpack_require__(47),
    DomHandler = __webpack_require__(129);
...
module.exports = {
	Parser: Parser,
	Tokenizer: __webpack_require__(48),
	ElementType: __webpack_require__(12),
	DomHandler: DomHandler,
	get FeedHandler() {
		return defineProp("FeedHandler", __webpack_require__(131));
	},
	get Stream() {
		return defineProp("Stream", __webpack_require__(132));
	},
	get WritableStream() {
		return defineProp("WritableStream", __webpack_require__(52));
	},
	get ProxyHandler() {
		return defineProp("ProxyHandler", __webpack_require__(148));
	},
	get DomUtils() {
		return defineProp("DomUtils", __webpack_require__(149));
	},
	get CollectingHandler() {
		return defineProp("CollectingHandler", __webpack_require__(161));
	},
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(138).setImmediate, __webpack_require__(2)))
...
var Tokenizer = __webpack_require__(48);
...
__webpack_require__(3)(Parser, __webpack_require__(19).EventEmitter);
...
var decodeMap = __webpack_require__(128);
...
var Parser = __webpack_require__(47),
    WritableStream = __webpack_require__(133).Writable || __webpack_require__(147).Writable,
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(26)(module), __webpack_require__(2)))
...
var _html2hscript = __webpack_require__(127);
...
var _observe = __webpack_require__(172);

var _observe2 = _interopRequireDefault(_observe);

var _virtualDom = __webpack_require__(173);
...
function render(data) {
    ...
    for (var key in data) {
        if (!(key == "$observeProps" || key == "$observerPath")) {
            nodes.push(new _virtualDom.VNode('li', {
                className: "greeting"
            }, [new _virtualDom.VText(key + '=>' + String(data[key]))]));
        };
    };
    return (0, _virtualDom.h)('ul', {
        className: "greeting"
    }, nodes);
};

(0, _observe2.default)(datasource, function (name, value, old) {
...
node = (0, _virtualDom.create)(tree);
document.body.appendChild(node);
setTimeout(function () {
    _axios2.default.get("http://192.168.203.71/user").then(function (response) {
...
function evil(fn) {
    window.h = _virtualDom.h;
    return new Function('return ' + fn)();
};
(0, _html2hscript2.default)('<ul class="greeting"><li class="greeting">node</li><li class="greeting">id=nx4276</li><li class="greeting">27</li></ul>', function (err, hscript) {
    document.body.appendChild((0, _virtualDom.create)(evil(hscript)));
});
console.log(datasource);
...
var camel = __webpack_require__(162);
var ent = __webpack_require__(165);
var isEmpty = __webpack_require__(170);
var thisIsSVGTag = __webpack_require__(37).thisIsSVGTag,
    getSVGNamespace = __webpack_require__(37).getSVGNamespace,
    getSVGAttributeNamespace = __webpack_require__(37).getSVGAttributeNamespace;
...
var ElementPrototype = __webpack_require__(130);
...
[__webpack_require__(150), __webpack_require__(156), __webpack_require__(157), __webpack_require__(158), __webpack_require__(159), __webpack_require__(160)].forEach(function (ext) {
...
var ElementType = __webpack_require__(12),
    getOuterHTML = __webpack_require__(151),
...
var ElementType = __webpack_require__(152);
var entities = __webpack_require__(153);
...
var encode = __webpack_require__(154),
    decode = __webpack_require__(155);
...
var inverseXML = getInverseObj(__webpack_require__(32)),
...
var entityMap = __webpack_require__(31),
    legacyMap = __webpack_require__(50),
    xmlMap = __webpack_require__(32),
    decodeCodePoint = __webpack_require__(49);
...
var toSpace = __webpack_require__(163);
...
var clean = __webpack_require__(164);
...
exports.decode = __webpack_require__(168);
...
var revEntities = __webpack_require__(167);
...
var punycode = __webpack_require__(58);
var entities = __webpack_require__(169);
...
var patch = __webpack_require__(177);
var h = __webpack_require__(183);
var create = __webpack_require__(192);
var VNode = __webpack_require__(65);
var VText = __webpack_require__(66);
...
var diff = __webpack_require__(175);
...
var diffProps = __webpack_require__(176);
...
var patch = __webpack_require__(178);
...
var domIndex = __webpack_require__(180);
var patchOp = __webpack_require__(181);
module.exports = patch;
...
var updateWidget = __webpack_require__(182);
...
var parseTag = __webpack_require__(185);
var softSetHook = __webpack_require__(187);
var evHook = __webpack_require__(188);
...
var split = __webpack_require__(186);
...
var EvStore = __webpack_require__(189);
...
var OneVersionConstraint = __webpack_require__(190);
...
var Individual = __webpack_require__(191);

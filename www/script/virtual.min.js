...
var Parser = __webpack_require__(46),
    DomHandler = __webpack_require__(128);
...
module.exports = {
	...
	get FeedHandler() {
		return defineProp("FeedHandler", __webpack_require__(130));
	},
	get Stream() {
		return defineProp("Stream", __webpack_require__(131));
	},
	get WritableStream() {
		return defineProp("WritableStream", __webpack_require__(51));
	},
	get ProxyHandler() {
		return defineProp("ProxyHandler", __webpack_require__(146));
	},
	get DomUtils() {
		return defineProp("DomUtils", __webpack_require__(147));
	},
	get CollectingHandler() {
		return defineProp("CollectingHandler", __webpack_require__(159));
	},
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(137).setImmediate, __webpack_require__(3)))
...
var Tokenizer = __webpack_require__(47);
...
var decodeCodePoint = __webpack_require__(48),
...
var Parser = __webpack_require__(46),
    WritableStream = __webpack_require__(132).Writable || __webpack_require__(145).Writable,
...
var minDoc = __webpack_require__(177);
...
var isVText = __webpack_require__(22);
var isWidget = __webpack_require__(8);
var handleThunk = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_html2hscript__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_html2hscript___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_html2hscript__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_utils__ = __webpack_require__(169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_observe__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_observe___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__utils_observe__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_virtual_dom__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_virtual_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_virtual_dom__);





var datasource = { user: { name: "nxiao", id: "nx4276", age: 27 } };
var tree = void 0,
    node = void 0;
...
function render(data) {
    ...
    for (var key in data) {
        if (!(key == "$observeProps" || key == "$observerPath")) {
            nodes.push(new __WEBPACK_IMPORTED_MODULE_4_virtual_dom__["VNode"]('li', {
                className: "greeting"
            }, [new __WEBPACK_IMPORTED_MODULE_4_virtual_dom__["VText"](key + '=>' + String(data[key]))]));
        };
    };
    return Object(__WEBPACK_IMPORTED_MODULE_4_virtual_dom__["h"])('ul', {
        className: "greeting"
    }, nodes);
};

__WEBPACK_IMPORTED_MODULE_3__utils_observe___default()(datasource, function (name, value, old) {
    var newtree = render(datasource.user);
    var patches = Object(__WEBPACK_IMPORTED_MODULE_4_virtual_dom__["diff"])(tree, newtree);
    tree = newtree;
    node = Object(__WEBPACK_IMPORTED_MODULE_4_virtual_dom__["patch"])(node, patches);
});
console.log(datasource);
tree = render(datasource.user);
node = Object(__WEBPACK_IMPORTED_MODULE_4_virtual_dom__["create"])(tree);
document.body.appendChild(node);
setTimeout(function () {
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("http://192.168.203.71/user").then(function (response) {
...
function evil(fn) {
    window.h = __WEBPACK_IMPORTED_MODULE_4_virtual_dom__["h"];
    return new Function('return ' + fn)();
};
__WEBPACK_IMPORTED_MODULE_1_html2hscript___default()('<ul class="greeting"><li class="greeting">node</li><li class="greeting">id=nx4276</li><li class="greeting">27</li></ul>', function (err, hscript) {
    document.body.appendChild(Object(__WEBPACK_IMPORTED_MODULE_4_virtual_dom__["create"])(evil(hscript)));
});
console.log(datasource);
...
var camel = __webpack_require__(160);
var ent = __webpack_require__(163);
var isEmpty = __webpack_require__(168);
var thisIsSVGTag = __webpack_require__(34).thisIsSVGTag,
    getSVGNamespace = __webpack_require__(34).getSVGNamespace,
    getSVGAttributeNamespace = __webpack_require__(34).getSVGAttributeNamespace;
...
module.exports = function (html, cb) {
    ...
    var parser = new Parser({
        ...
        onclosetag: function onclosetag(tagname) {
            ...
            var item = 'h(' + JSON.stringify(element[0] + idSuffix + classSuffix) + (objectStr !== "" ? ", " + objectStr : "") + (elementContent.length ? ', [' + (elementContent[0] === "\n" ? '' : ' ') + elementContent + (elementContent.match(/\s$/) ? '' : ' ') + ']' : '') + ')';
...
var NodePrototype = __webpack_require__(50);
var ElementPrototype = __webpack_require__(129);
...
[__webpack_require__(148), __webpack_require__(154), __webpack_require__(155), __webpack_require__(156), __webpack_require__(157), __webpack_require__(158)].forEach(function (ext) {
...
var ElementType = __webpack_require__(13),
    getOuterHTML = __webpack_require__(149),
...
var ElementType = __webpack_require__(150);
var entities = __webpack_require__(151);
...
var encode = __webpack_require__(152),
    decode = __webpack_require__(153);
...
var toSpace = __webpack_require__(161);
...
var clean = __webpack_require__(162);
...
exports.encode = __webpack_require__(164);
exports.decode = __webpack_require__(166);
...
var revEntities = __webpack_require__(165);
...
module.exports = {
    observe: function observe(datasource, callback) {
...
var oba = function oba(target, arr, callback) {
...
var diff = __webpack_require__(172);
var patch = __webpack_require__(175);
var h = __webpack_require__(181);
var create = __webpack_require__(190);
var VNode = __webpack_require__(64);
var VText = __webpack_require__(65);
...
var diff = __webpack_require__(173);
...
var diffProps = __webpack_require__(174);
...
var patch = __webpack_require__(176);
...
var render = __webpack_require__(62);
var domIndex = __webpack_require__(178);
var patchOp = __webpack_require__(179);
module.exports = patch;
...
var updateWidget = __webpack_require__(180);
...
var parseTag = __webpack_require__(183);
var softSetHook = __webpack_require__(185);
var evHook = __webpack_require__(186);
...
var split = __webpack_require__(184);
...
var EvStore = __webpack_require__(187);
...
var OneVersionConstraint = __webpack_require__(188);
...
var Individual = __webpack_require__(189);
